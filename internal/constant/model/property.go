...
type Property struct {
	...
	Coordinate    string  `gorm:"coordinate,omitempty" json:"coordinate,omitempty"`
	Location      string  `gorm:"location,omitempty" json:"location,omitempty"`
	PostalCode    string  `gorm:"postal_code,omitempty" json:"postal_code,omitempty"`
	StreetAddress string  `gorm:"street_address,omitempty" json:"street_address,omitempty"`
...
func (p Property) Validate() error {
	return validation.ValidateStruct(&p,
		...
		validation.Field(&p.Coordinate, validation.Required),
		validation.Field(&p.Location, validation.Required),
		validation.Field(&p.PostalCode, validation.Required),
		validation.Field(&p.StreetAddress, validation.Required),
